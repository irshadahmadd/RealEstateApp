...
import 'package:realstateapp/1)%20Onboarding/splash4.dart';
  ...
  void initState(){
    ...
    Timer(
      const Duration(seconds: 4),(
        (){
          Navigator.pushReplacement(context,MaterialPageRoute(builder: (context)=>const Splash4()));
        }
    )
    );
  }
    ...
    return Container(
      ...
      decoration:  BoxDecoration(
        image: DecorationImage(
          ...
          image: const AssetImage("assets/splash3bg.jpg"),),
                  ...
                  SizedBox(height: MediaQuery.of(context).size.height/30,),
                   Padding(
                      ...
                      child: DefaultTextStyle(
                        ...
                        child: const Text('We focus providing The most up place for you',textAlign: TextAlign.center,),
