  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:  Text("House",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Theme.of(context).backgroundColor),),
        actions:  [
          Padding(
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: const Text("House",style: TextStyle(fontSize: 14),),
                            ),
